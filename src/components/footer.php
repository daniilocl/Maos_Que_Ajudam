        ...
        <section class="">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
              ...
              <p>
                <a class="text-black">Quem Somos</a>
              </p>
              <p>
                <a class="text-black">Projetos</a>
              </p>
              <p>
                <a class="text-black">Como Ajudar</a>
              </p>
              <p>
                <a class="text-black">Contato</a>
              </p>
            </div>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              <p><i class="fas fa-envelope mr-3"></i> contato@maosqueajudam.org</p>
              <p><i class="fas fa-phone mr-3"></i> 📞 +55 (11) 99999-9999</p>
              <p><i class="fas fa-print mr-3"></i> 🕒 Atendimento: segunda a sexta, das 9h às 17h</p>
            </div>
            <!-- Grid column -->
          </div>
          <!--Grid row-->
        ...
        <section class="p-3 pt-0">
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-7 col-lg-8 text-center text-md-start">
              <!-- Copyright -->
              <div class="p-3">
                © 2025 Mãos Que Ajudam. Todos os direitos reservados!
                <!-- Grid column -->
