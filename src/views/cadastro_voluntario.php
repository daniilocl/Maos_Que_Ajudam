...
<body>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <form action="" method="post" class="bg-white form-cadastro">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nome" id="nome" placeholder="Seu nome completo" required value="<?= htmlspecialchars($nome) ?>">
                        </div>

                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" name="email" id="email" placeholder="nome@exemplo.com" required value="<?= htmlspecialchars($email) ?>">
                        </div>

                        <div class="mb-4">
                            <label for="cpf" class="form-label">CPF (Somente números)</label>
                            <input type="text" class="form-control" name="cpf" id="cpf" placeholder="000.000.000-00" maxlength="14" required value="<?= htmlspecialchars($cpf) ?>">
                        </div>
    ...
    <!-- ... O restante do seu HTML (Cards e Footer) ... -->
